...
image_generator = Agent(
    ...
    goal='Generate cute and appealing images for Terrible Teddies cards',
    backstory='You are an AI artist specializing in creating adorable teddy bear illustrations',
    verbose=True,
    llm=llm
)
...
generate_card_images = Task(
    description='Generate 40 unique, cute teddy bear images for game cards',
