export const teddyCards = [
  ...
  { id: 7, name: "Teddy's Revenge", type: "action", stuffingCost: 3, effect: "damage", value: 5 },
  { id: 8, name "Fluffy Armor", type: "equipment", stuffingCost: 2, effect: "defense", value: 3 },
  { id: 9, name: "Stuffing Factory", type: "location", stuffingCost: 2, effect: "stuffing", value: 2 },
  { id: 10, name: "Bear Hug", type: "action", stuffingCost: 1, effect: "health", value: 2 },
];