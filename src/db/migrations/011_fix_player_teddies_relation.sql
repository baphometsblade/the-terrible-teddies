-- Drop the existing player_teddies table if it exists
DROP TABLE IF EXISTS public.player_teddies;

-- Recreate the player_teddies table with proper foreign key constraints
