...
export const ALL_CARDS = [
  ...
  { id: 1, name: "Shitstarter Ted", attack: 3, defense: 2, type: 'action', cost: 2, ability: 'none', rarity: 'common', fur: "chocolate brown", visual: "barrel-chested bear, torn ear, leather biker vest, brass knuckles on one paw", description: "Every bar fight in this town starts with Ted." },
  { id: 2, name: "Feral Tim", attack: 1, defense: 1, type: 'action', cost: 1, ability: 'swarm', rarity: 'common', fur: "raccoon grey", visual: "tiny runt bear, dirt-matted fur, feral claw scratches, ragged fingerless gloves", description: "Raised by raccoons. It shows." },
  { id: 3, name: "Fluffy McFuckface", attack: 2, defense: 2, type: 'action', cost: 2, ability: 'none', rarity: 'common', fur: "cream white", visual: "squat and fat bear, chubby cheeks, mismatched button eyes, stained bowling shirt", description: "Legally changed his name. Won the bet." },
  { id: 4, name: "Bar-Fight Barry", attack: 2, defense: 1, type: 'action', cost: 1, ability: 'none', rarity: 'common', fur: "rust red", visual: "lanky bear, black eye, missing teeth, sleeveless torn flannel shirt", description: "Banned from six pubs and one build-a-workshop." },
  { id: 5, name: "Stitches the Snitch", attack: 1, defense: 3, type: 'action', cost: 2, ability: 'none', rarity: 'common', fur: "faded plum", visual: "scrawny bear, stitched muzzle scar, cracked glasses, snitch's clipboard tucked under one arm", description: "Held together by thread and plea deals." },

  // Uncommon
  { id: 6, name: "Shit-Talk Sally", attack: 2, defense: 3, type: 'action', cost: 2, ability: 'taunt', rarity: 'uncommon', fur: "faded pink", visual: "lanky bear, permanent snarl, gold hoop earrings, popped-collar leather jacket, finger jabbing forward", description: "Runs her mouth until you HAVE to hit her. That's the plan." },
  { id: 7, name: "Peeping Pete", attack: 3, defense: 1, type: 'action', cost: 2, ability: 'stealth', rarity: 'uncommon', fur: "moss green", visual: "scrawny moth-eaten bear, one eye peering out, trench coat collar turned up, binoculars around neck", description: "You can't target what's hiding in your hamper." },
  { id: 8, name: "Chokehold Cuddles", attack: 2, defense: 4, type: 'action', cost: 3, ability: 'shield', rarity: 'uncommon', fur: "charcoal grey", visual: "barrel-chested bear, cauliflower ear, duct-taped cardboard breastplate, wrestling singlet straps", description: "His hugs are technically a submission move." },
  { id: 9, name: "Shiv-in-a-Pillow", attack: 4, defense: 1, type: 'action', cost: 3, ability: 'piercing', rarity: 'uncommon', fur: "dirty white", visual: "squat bear, cracked plastic nose, torn pillowcase seam, rusty shiv gripped in one paw", description: "Soft on the outside. Very much not on the inside." },
  { id: 10, name: "Anger-Management Gus", attack: 3, defense: 2, type: 'action', cost: 2, ability: 'fury', rarity: 'uncommon', fur: "mustard yellow", visual: "hulking bear, bloodshot eyes, torn straightjacket sleeves, crumpled therapy pamphlet in one paw", description: "Dropped out of the program. The program was relieved." },

  // Rare
  { id: 11, name: "Restraining-Order Randy", attack: 1, defense: 5, type: 'action', cost: 3, ability: 'protect', rarity: 'rare', fur: "slate grey", visual: "broad bear, one eye missing, neck brace, court papers stapled across his chest, arms braced wide", description: "You legally cannot get within 50 feet of his friends." },
  { id: 12, name: "'Roid-Rage Reggie", attack: 2, defense: 3, type: 'action', cost: 3, ability: 'fury', rarity: 'rare', fur: "brick red", visual: "hulking bear, veins bulging under matted fur, ripped gym cut-off shirt, chalk-dusted paws", description: "The stuffing is 90% pre-workout." },
  { id: 13, name: "The F-Bomb", attack: 5, defense: 0, type: 'action', cost: 4, ability: 'none', rarity: 'rare', fur: "jet black", visual: "scrawny bear with singed fur, wild eyes, bandolier of tiny liquor bottles", description: "Drops hard. Offends everyone. No survivors." },
  { id: 14, name: "Slumlord Cotton", attack: 3, defense: 3, type: 'action', cost: 4, ability: 'royal', rarity: 'rare', fur: "cotton white", visual: "squat bear, smug expression, ill-fitting tiny business suit, gold rings, jangling key ring at belt", description: "Owns half the toy chest. Fixes none of it." },
  { id: 15, name: "Tax-Fraud Teddy", attack: 4, defense: 2, type: 'action', cost: 3, ability: 'stealth', rarity: 'rare', fur: "dusty plum", visual: "lanky bear, shifty sidelong glance, briefcase handcuffed to one wrist, sunglasses indoors, loosened tie", description: "Officially, he doesn't exist. Ask his accountant." },

  // Epic
  { id: 16, name: "Lord Fluffington, Disgraced", attack: 4, defense: 4, type: 'action', cost: 5, ability: 'shield', rarity: 'epic', fur: "ash blonde", visual: "hulking bear, cracked monocle, dented armor breastplate under a torn velvet fur coat, broken tiara", description: "Lost the estate. Kept the attitude and the armor." },
  { id: 17, name: "Blackout Bjorn", attack: 6, defense: 1, type: 'action', cost: 4, ability: 'fury', rarity: 'epic', fur: "dark auburn", visual: "hulking bear, glazed unfocused eyes, shredded Hawaiian shirt, empty liquor bottles strung as a necklace", description: "Remembers nothing. Regrets everything. Hits like a truck." },
  { id: 18, name: "Grandpa Warcrimes", attack: 2, defense: 6, type: 'action', cost: 5, ability: 'protect', rarity: 'epic', fur: "gunmetal silver", visual: "broad bear, bandaged head, tattered army surplus jacket heavy with medals, one paw raised to shield", description: "Don't ask what he did in the Pillow Wars. He'll tell you." },
  { id: 19, name: "The Seam Reaper", attack: 5, defense: 3, type: 'action', cost: 5, ability: 'piercing', rarity: 'epic', fur: "bone pale", visual: "lanky bear, stitched-shut eye, tattered black hooded robe, rusty sewing-scissors scythe raised high", description: "Comes for every bear's thread eventually." },

  // Legendary
  { id: 20, name: "The Godfluffer", attack: 5, defense: 5, type: 'action', cost: 6, ability: 'taunt', rarity: 'legendary', fur: "oxblood brown", visual: "over-stuffed bear, gold chains, pinstripe suit straining at the seams, fat cigar in his teeth", description: "He'll make you an offer you can't refuse. Or ignore." },
  { id: 21, name: "Fluffpocalypse Now", attack: 7, defense: 3, type: 'action', cost: 6, ability: 'fury', rarity: 'legendary', fur: "soot blackened", visual: "hulking bear, cracked aviator sunglasses, bandolier of grenades, camo headband, fur still smoking", description: "Loves the smell of stuffing in the morning." },
  ...
  { id: 50, name: "Dumpster Dave", attack: 2, defense: 2, type: 'action', cost: 2, ability: 'none', rarity: 'common', fur: "olive green", visual: "squat grimy bear, flies circling his head, trash-bag poncho, banana peel stuck to one paw", description: "Lives behind the bar. Smells like decisions." },
  { id: 51, name: "Mange Marvin", attack: 3, defense: 1, type: 'action', cost: 2, ability: 'none', rarity: 'common', fur: "burnt orange", visual: "scrawny patchy bear, bald mange spots, scabby skin, frayed rope leash dragging behind him", description: "The bald patches are from stress. And mange." },
  { id: 52, name: "Two-Beer Tina", attack: 2, defense: 2, type: 'action', cost: 2, ability: 'none', rarity: 'common', fur: "honey blonde", visual: "squat bear, smeared lipstick, tipsy grin, tank top, dented beer can crushed in one paw", description: "Two beers in and she's everyone's problem." },
  { id: 53, name: "Coupon Carl", attack: 1, defense: 2, type: 'action', cost: 1, ability: 'none', rarity: 'common', fur: "dull khaki", visual: "lanky bear, permanent scowl, coupon-stuffed fanny pack, cheap plastic visor, calculator gripped in paw", description: "Fights dirty. Tips worse." },
  { id: 54, name: "Sticky Mickey", attack: 1, defense: 3, type: 'action', cost: 2, ability: 'none', rarity: 'common', fur: "golden amber", visual: "squat bear, fur matted with dried honey, sticky handprints, honey-crusted apron, flies buzzing near ears", description: "Nobody asks why he's sticky. Nobody wants to know." },
  { id: 55, name: "Ashtray Annie", attack: 2, defense: 1, type: 'action', cost: 1, ability: 'none', rarity: 'common', fur: "smoky blue-grey", visual: "lanky bear, cigarette dangling from a stitched mouth, plastic hair curlers, threadbare bathrobe, ash smudges", description: "Smells like 1987 and menthols." },
  { id: 56, name: "Bouncer Bruno", attack: 2, defense: 4, type: 'action', cost: 3, ability: 'taunt', rarity: 'uncommon', fur: "espresso brown", visual: "barrel-chested bear, cauliflower ear, referee-stripe armband, arms crossed, chest puffed out", description: "You're not on the list. Nobody is on the list." },
  { id: 57, name: "Hairball Harriet", attack: 3, defense: 2, type: 'action', cost: 3, ability: 'piercing', rarity: 'uncommon', fur: "ginger shaggy", visual: "scrawny bear, hacking cough, cracked pool cue gripped like a spear, fish-bone necklace", description: "Coughs up more than hairballs." },
  { id: 58, name: "Prison-Wine Pierre", attack: 2, defense: 2, type: 'action', cost: 2, ability: 'fury', rarity: 'uncommon', fur: "wine maroon", visual: "squat bear, crude jailhouse tattoos across his chest, torn prison jumpsuit, bottle-cap necklace, unhinged grin", description: "Ferments grudges in a toilet. Delicious." },
  { id: 59, name: "Glitter Lungs", attack: 2, defense: 2, type: 'action', cost: 2, ability: 'stealth', rarity: 'uncommon', fur: "teal glitter-flecked", visual: "tiny runt bear, hood pulled low concealing his face, sequins scattered through patchy fur, darting eyes", description: "Inhaled a craft store in '09. Still sparkles when he coughs." },
  { id: 60, name: "Beargaritaville", attack: 2, defense: 3, type: 'action', cost: 2, ability: 'shield', rarity: 'uncommon', fur: "turquoise blue", visual: "barrel-chested bear, peeling sunburn patches, foam pool-noodle armor strapped to his chest, salt-rimmed margarita glass", description: "Wastes away. Aggressively." },
  { id: 61, name: "Snitchslap Sue", attack: 3, defense: 3, type: 'action', cost: 3, ability: 'none', rarity: 'uncommon', fur: "dusty rose", visual: "lanky bear, fresh black eye, informant's wire taped under a torn cardigan, paw raised to slap", description: "Court-ordered to stay 50 feet from Stitches." },
  { id: 62, name: "Chainsmoke Chad", attack: 4, defense: 2, type: 'action', cost: 3, ability: 'fury', rarity: 'rare', fur: "nicotine yellow", visual: "hulking bear, chain wallet swinging, cigarette burns peppering his chest, eyes wild with the shakes", description: "Lights the next one off your burning deck." },
  { id: 63, name: "Bail-Money Bonnie", attack: 2, defense: 4, type: 'action', cost: 3, ability: 'protect', rarity: 'rare', fur: "rich plum", visual: "broad bear, gold tooth glinting, oversized fur coat, phone clamped to one ear, other arm braced protectively", description: "She knows a guy. She IS the guy." },
  { id: 64, name: "Sgt. Snuggles, Dishonorable", attack: 4, defense: 3, type: 'action', cost: 4, ability: 'shield', rarity: 'rare', fur: "olive drab", visual: "hulking bear, ripped-off medal patches, dented trash-can-lid shield strapped to one arm, stitched permanent scowl", description: "Discharged for conduct unbearable." },
  { id: 65, name: "The Debt Collector", attack: 5, defense: 1, type: 'action', cost: 4, ability: 'piercing', rarity: 'rare', fur: "smoke black", visual: "lanky bear, cracked plastic nose, tire iron resting on one shoulder, debt clipboard tucked under arm", description: "Your kneecaps called. They're nervous." },
  { id: 66, name: "Mama Mauls", attack: 5, defense: 3, type: 'action', cost: 5, ability: 'taunt', rarity: 'epic', fur: "caramel blonde", visual: "over-stuffed bear, claw marks across her muzzle, blood-stained floral apron, tiny teeth necklace, chest puffed out snarling", description: "Ask about her cubs. Go ahead. Ask." },
  { id: 67, name: "Whiskey Priest", attack: 3, defense: 5, type: 'action', cost: 5, ability: 'protect', rarity: 'epic', fur: "dove grey", visual: "broad bear, glassy eyes, torn priest collar, whiskey flask in his cassock, arm raised in blessing", description: "Absolves everything but his own tab." },
  { id: 68, name: "Duke of Dumpsterfire", attack: 6, defense: 2, type: 'action', cost: 5, ability: 'fury', rarity: 'epic', fur: "charred black", visual: "hulking bear, singed crown of bottle caps, tattered fur-trimmed cape, lit matchbook flaring in one paw", description: "Royalty of the alley. Arsonist of the heart." },
  { id: 69, name: "Big Spoon, Last Warning", attack: 6, defense: 4, type: 'action', cost: 6, ability: 'shield', rarity: 'legendary', fur: "battleship grey", visual: "hulking over-stuffed bear, chest scars, spiked collar, arms spread wide", description: "The cuddle is mandatory. The survival is optional." },
